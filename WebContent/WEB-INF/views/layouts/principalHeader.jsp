...
<div id="header" class="header" style="height: 90px">
	<div class="container">
		...
		<div class="logo">
			<a href="#><img
				style="margin-top: 20px !important;" src="images/logo1.png" alt=""></a>
		</div>
		<!-- END / LOGO -->
				...
				<li class="menu-item-has-children megamenu col-4"><a
					...
					<ul class="sub-menu">
						 <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="javascript:void(0)">Account Assignment</a></li>
                            ...
                            <li class="menu-item-has-children">
                                <a href="javascript:void(0)">Learn 3</a>
                                <ul class="sub-menu">
			...
			<ul class="list-account-info">
				...
				<li class="list-item notification">
					<div class="notification-info item-click">
						<i class="icon fa fa-bell"></i> <span class="itemnew"></span>
					</div>
				...
				<li class="list-item account">
					...
					<div class="toggle-account toggle-list">
						<ul class="list-account">
							...
							<li><a href="updatePrincipalProfile"><i
									class="icon  fa fa-cog"></i>Profile</a></li>
