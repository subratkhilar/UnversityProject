					...
					<li class="menu-item-has-children megamenu col-4"><a
						...
						<ul class="sub-menu">
							<li class="menu-item-has-children"><a
								...
								<ul class="sub-menu">
									<li><a href="createBranch">Branch</a></li>
									<li><a href="createSubject">Subject</a></li>
									<li><a href="#">Teacher</a></li>
									<li><a href="createSection">Section</a></li>
									<li><a href="studentReg">Admission</a></li>
									<li><a href="createTimeTable">Timetable</a></li>
									<li><a href="principal">Principal</a></li>
									<li><a href="#">Vendor</a></li>
									<li><a href="#">Feedback Criteria</a></li>
									<li><a href="registerLibrarian">Librarian</a></li>
							...
							<li class="menu-item-has-children"><a
								...
								<ul class="sub-menu">
									<li><a href="registerTeacherWithSubject">Teacher With Subject</a></li>
