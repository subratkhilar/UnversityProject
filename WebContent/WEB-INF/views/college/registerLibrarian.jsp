				...
				success : function(data) {
					...
					$.each(data, function(i, item) {
						...
						trHTML += '<tbody><tr><td>' + item.name
								...
								+ '</td><td>'+item.address+'</td></td></tr></tbody>';
		...
		<div class="row">
			...
			<div class="col-lg-7 col-md-7" style="margin-top: 10px">
				<div class="form-login well well-lg"
					...
					<h2 style="color: #37abf2">Librarian List</h2>
			...
			<div class="col-lg-4 col-md-4" style="margin-top: 10px">
				<div class="form-login"
					...
					<form>
						<div id="message"></div>
						<h2 style="color: #37abf2 !important;">Register Librarian</h2>
						...
						<div class="form-address">
							<textarea type="text" name="educationQualification"
								id="educationQualification"
								placeholder="Education Qualification"></textarea>
						</div>
