...
public class TeacherController {
	...
	public String getAllEventDetails(ModelMap model,@RequestBody String eventName ) {
		System.out.println("eventName is "+eventName);
		model.addAttribute("user", HomeController.getPrincipal());
		//model.addAttribute("eventList", teacherService.getAllEventDetails(HomeController.getPrincipal()));
		return "viewUpdCurriculum";
	}
