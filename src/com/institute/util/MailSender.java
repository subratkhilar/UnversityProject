...
public class MailSender {
	...
	public static void generateAndSendEmail() throws AddressException,
		...
		generateMailMessage.addRecipient(Message.RecipientType.TO,
				new InternetAddress("dashpk90@gmail.com"));
		generateMailMessage.addRecipient(Message.RecipientType.CC,
				new InternetAddress("subrat.khilar@gmail.com"));
		generateMailMessage.setSubject("Greetings from Crunchify..");
		String emailBody = "Test email by KD group . "
				+ "<br><br> Regards, <br>Spana Admin";
		...
		transport.connect("smtp.gmail.com", "subrat.khilar@gmail.com",
				"gopinath06");
